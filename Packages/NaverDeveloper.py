...
if __name__ == "__main__":
    naverDeveloper = NaverDeveloper("6h3xDGbWJCmKPPXBhTK3", "vH3ZsopteI")

    result = naverDeveloper.get_total_count("물티슈")
    result_cbshop = naverDeveloper.get_cbshop_count("물티슈")

    print(result, result_cbshop)
